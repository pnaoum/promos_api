    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promo_code', models.ForeignKey(db_column='promo_code', on_delete=django.db.models.deletion.CASCADE, to='promos.promo', to_field='promo_code')),
        ...
        migrations.AddField(
            ...
            name='promos',
            field=models.ManyToManyField(through='users.UserPromos', to='promos.Promo'),
        ),
        migrations.AddField(
            model_name='customuser',
